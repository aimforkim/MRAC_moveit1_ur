...
def robot_program():
    ...
    sequence.append(Ptp(goal=poses[0]))
    sequence.append(Lin(goal=poses[1]))
    # sequence.append(Ptp(goal=poses[2], vel_scale=0.2, acc_scale=0.2))
    # sequence.append(Lin(goal=poses[3], vel_scale=0.2, acc_scale=0.2))
    sequence.append(Ptp(goal=home, vel_scale=0.2, acc_scale=0.2))
